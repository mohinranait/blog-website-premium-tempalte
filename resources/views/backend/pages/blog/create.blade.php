    ...
    <div class="br-mainpanel">
        <div class="br-pagetitle" style='margin-top:-20px;background:linear-gradient(to right, #1CAF9A 0%, #17A2B8 100%)'>
            ...
            <div>
                ...
                <p class="mg-b-0">Create New post.</p>
            </div>
        </div>
                ...
                <div class="col-sm-6 col-xl-12">
                    ...
                    <div class='bg-white  p-4'>
                        <form action="{{route('post-store')}}" method="POST" enctype='multipart/form-data'>
                            ...
                            <div class="form-group">
                                <textarea name="body" class='form-control' id="ckeditor" required cols="30" rows="10"></textarea>
                            </div>
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <label for="">Fiture Image<sup class='text-danger'>*</sup></label> <br>
                                       <input type="file" name='fitureimg' required class='form-file-control'>
                                    </div>
                                    
                                </div>
                            </div> 
                            <input type="submit" value='New Post' class='btn w-100' style='background:linear-gradient(to right, #1CAF9A 0%, #17A2B8 100%)'>
                        </form>
                    </div>
